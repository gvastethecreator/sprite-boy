...
import { ToastData, ExportModalState, GenerationModalState, GenerationPanelState, ViewportState } from '../types';
...
export function useUIController() {
    ...
    const [generationModal, setGenerationModal] = useState<GenerationModalState>({ isOpen: false, targetSlotIndex: null });
    ...
    // Toast Logic
    const showToast = useCallback((msg: string, type: 'success' | 'error' | 'info' = 'info', soundEnabled: boolean = true) => {
        const id = generateId();
    ...
    return {
        ...
        generationModal, setGenerationModal,
        analysisResult, setAnalysisResult,
        genPanel, setGenPanel,
        bgPreviewBlobUrl, setBgPreviewBlobUrl,
