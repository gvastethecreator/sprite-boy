...
import { AppMode, DragMode, DND_ASSET_TYPE, ViewportState, FrameData, SlotData, BuilderCanvasSize, GridConfig, ImageMeta } from '../../types';
...
export function useCanvasMouse(deps: CanvasMouseDeps) {
    ...
    const getRelMouse = useCallback((cx: number, cy: number) => {
    ...
    }, [isEmpty, isEyedropperActive, isSpacePressed, onPickColor, canvasRef, getRelMouse, currentMode, builderCanvas, gridConfig, imageMeta, frames, builderSlots, onSelectFrame]);
    ...
    }, [dragMode, getRelMouse, viewport, setViewport, lastMousePos, builderCanvas, gridConfig, currentMode, selectedFrameIndex, builderSlots, frames, onUpdateSlotEphemeral, onUpdateFrameEphemeral]);
    ...
    const handleMouseUp = useCallback(() => {
        ...
        setDragHoverSlot(null);
    }, [dragMode, dragStartSlot, dragHoverSlot, currentMode, selectedFrameIndex, builderSlots, frames, onSwapSlots, onSelectFrame, onUpdateSlot, onUpdateFrame]);
