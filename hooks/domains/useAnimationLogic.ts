...
export function useAnimationLogic(
    ...
    const handleReorderFrames = (frames: Keyframe[]) => {
         ...
         setProject(prev => ({
            ...prev,
            animations: prev.animations.map(a => a.id === activeAnimationId ? { ...a, keyframes: frames } : a)
         }));
    };
    ...
    return {
        ...
        playbackFrameIndex, setPlaybackFrameIndex,
        isPlaying, setIsPlaying,
        handleAddAnimation, handleUpdateAnimation, handleDeleteAnimation, handleDuplicateAnimation,
        handleAddKeyframe, handleDeleteKeyframe, handleDuplicateKeyframe, handleUpdateKeyframe, handleReorderFrames, handleStepFrame
    };
}
