...
describe('useAnimationLogic', () => {
    ...
    it('handleDuplicateAnimation copies animation with new id', () => {
        project = makeProject({
            animations: [{ id: 'a1', name: 'Idle', fps: 10, loop: true, keyframes: [{ uid: 'k1', sourceIndex: 0, pivotX: 0.5, pivotY: 0.5, rotation: 0, scaleX: 1, scaleY: 1, opacity: 1 }] }],
        });
        const { result } = hook();
    ...
    it('handleDeleteKeyframe removes keyframe at index', () => {
        project = makeProject({
            animations: [{
                ...
                keyframes: [
                    { uid: 'k1', sourceIndex: 0, pivotX: 0.5, pivotY: 0.5, rotation: 0, scaleX: 1, scaleY: 1, opacity: 1 },
                    { uid: 'k2', sourceIndex: 1, pivotX: 0.5, pivotY: 0.5, rotation: 0, scaleX: 1, scaleY: 1, opacity: 1 },
                ],
            }],
        });
        const { result } = hook();
    ...
    it('handleReorderFrames replaces keyframes for active animation', () => {
        const kf1 = { uid: 'k1', sourceIndex: 0, pivotX: 0.5, pivotY: 0.5, rotation: 0, scaleX: 1, scaleY: 1, opacity: 1 };
        const kf2 = { uid: 'k2', sourceIndex: 1, pivotX: 0.5, pivotY: 0.5, rotation: 0, scaleX: 1, scaleY: 1, opacity: 1 };
        project = makeProject({
        ...
        project = makeProject({
            animations: [{
                ...
                keyframes: [
                    { uid: 'k1', sourceIndex: 0, pivotX: 0.5, pivotY: 0.5, rotation: 0, scaleX: 1, scaleY: 1, opacity: 1 },
                    { uid: 'k2', sourceIndex: 1, pivotX: 0.5, pivotY: 0.5, rotation: 0, scaleX: 1, scaleY: 1, opacity: 1 },
                    { uid: 'k3', sourceIndex: 2, pivotX: 0.5, pivotY: 0.5, rotation: 0, scaleX: 1, scaleY: 1, opacity: 1 },
                ],
            }],
        });
        const { result } = hook();
