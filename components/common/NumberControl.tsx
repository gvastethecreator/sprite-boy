    ...
    <div className={`flex flex-col gap-1.5 ${className}`}>
      <div className="flex items-center gap-2">
        ...
        >
          ...
          {unit && (
            <span className="text-[9px] font-bold text-textMuted/40 px-1 select-none">{unit}</span>
          )}
          ...
          {!disabled && (
            <div className="flex flex-col border-l border-white/5 w-5 h-full shrink-0 bg-white/5">
              <button
                ...
                className="flex-1 hover:bg-white/10 flex items-center justify-center text-textMuted hover:text-white transition-colors border-none"
              >
                <ChevronUp size={10} />
              </button>
              <button
                ...
                className="flex-1 hover:bg-white/10 flex items-center justify-center text-textMuted hover:text-white border-t border-white/5 transition-colors border-none"
              >
                <ChevronDown size={10} />
              </button>
            </div>
