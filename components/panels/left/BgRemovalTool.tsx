  ...
  return (
    <div className="shrink-0 p-4 border-t border-border/20 bg-app/20">
      <div className="flex items-center justify-between mb-3 px-1">
        <span className="text-xs font-bold text-textMuted uppercase flex items-center gap-2 tracking-wider">
          <Eraser size={14} /> BG Removal
        </span>
      ...
      <div
        className={`bg-surface/30 p-4 rounded-lg border border-border/40 space-y-4 ${isDisabled ? "opacity-50 pointer-events-none" : ""}`}
      >
        <div className="flex gap-3 items-stretch h-9">
          <div
            className="w-12 rounded-md border border-border relative overflow-hidden shrink-0 shadow-sm group cursor-pointer"
