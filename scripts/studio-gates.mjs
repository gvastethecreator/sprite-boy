...
const STEPS = Object.freeze({
  ...
  composeCanvasBrowser: processStep(
    "compose-canvas-browser",
    "Canvas-first Compose image grid journey",
    ["scripts/studio-compose-bootstrap-browser.mjs"],
    180_000,
  ),
});
...
export const STUDIO_GATE_MANIFEST = Object.freeze({
  ...
  gates: Object.freeze({
    ...
    e2e: gate("e2e", "Production browser smoke", [
      STEPS.build,
      STEPS.browser,
      STEPS.videoBrowser,
      STEPS.composeCanvasBrowser,
    ]),
