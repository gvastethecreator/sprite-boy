...
export async function generateSprite(
  ...
  switch (mode) {
    ...
    case "variation":
      systemInstruction +=
        " Maintain style, color palette and pixel scale of context images. Create a variation.";
      break;
    case "inbetween":
      systemInstruction +=
        " Create a single intermediate frame for a smooth animation between the provided images.";
      break;
    case "edit_context":
    ...
    case "full_sheet":
      systemInstruction +=
        " Create a full sprite sheet grid. Use context images as character reference.";
      break;
  }
