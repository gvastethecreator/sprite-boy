...
| G2-05 | J | G2-03,G2-04 | G2.1-G2.6 | Manual/auto switching and deterministic recipe state | BR+RT | active |
...
| S1-03 | J | S1-01 | H4.5-H4.6 | Manual create/move/resize/delete Region commands | UT+undo | active |
