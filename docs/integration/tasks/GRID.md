...
| G0-05 | J | G0-02,G0-04 | G1.1-G1.6 | Error/focus/retry gate de source session | Hostile BR+A11Y | active |
...
| G2-02 | J | G2-01 | G2.2-G2.5 | Energy profile, segment detection y grid inference | Golden/property UT | active |
...
| G3-03 | E | G3-02 | G3.1-G3.4 | Crop controls, preview summary y reset | BR+A11Y + REV | todo |
