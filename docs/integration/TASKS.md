...
F0, B0, F1, F2, F3-01..F3-06 y F4-01..F4-03 están aceptados. `F3-07` sigue
pendiente del journey browser save-close-reload/export-import; `F4-04` y
`F4-05` quedan autorizados en paralelo por sus dependencias aceptadas.
