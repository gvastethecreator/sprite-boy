...
**Wave 0 (F0+B0), F1, F2, F3-01..F3-06 y F4-01..F4-04 aceptados. Frontiers: F3-07 pendiente de browser; F4-05 autorizado.**
...
F4-04 ya cerró history transaccional; F4-05 es el frontier de selectors y
primer consumer batch antes del gate conjunto F4-06.
